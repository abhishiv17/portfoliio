 ...
 *   style?: import('react').CSSProperties, prefixWidth?: string,
...
export function TextStream({
  ...
  return (
    <div className={cn("obsidian-text-stream font-heading text-foreground", className)} style={{ display: "flex", alignItems: "center", height, ...style }}>
      {/* Left - static prefix */}
      <div style={{ width: prefixWidth || "auto", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "flex-start", paddingRight: 8 }}>
